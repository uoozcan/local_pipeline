...
# Set passphrase (set this in your environment before running)
...
if [ $failed_transfers -gt 0 ]; then
    ...
    log_msg "  Edit ${BAM_FILE_LIST} with failed files"
    log_msg "  sbatch ${SCRIPTS_DIR}/step1_transfer_bam.sh"
else
...
log_msg ""
log_msg "NEXT STEP:"
log_msg "  bash ${SCRIPTS_DIR}/step2_submit_array_job.sh"
