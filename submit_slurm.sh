...
INPUT_DIR="/home/umut/projects/project_2008084/ozcanumu/hla_rnaseq_analysis/raw_bam"
INPUT_TYPE="bam"                      # bam, cram, or fastq
TOOLS="arcashla"                      # Comma-separated: optitype,arcashla,spechla
OUTDIR="./results"
...
module purge
module load biokit freebayes nextflow
