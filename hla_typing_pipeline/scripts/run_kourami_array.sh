...
PIPELINE_BIN="/projappl/${PROJECT_ID}/local_pipeline/hla_typing_pipeline/bin"
KOURAMI_JAR="/projappl/${PROJECT_ID}/kourami/kourami-0.9.6/build/Kourami.jar"
KOURAMI_DB="/projappl/${PROJECT_ID}/kourami/kourami_db"
